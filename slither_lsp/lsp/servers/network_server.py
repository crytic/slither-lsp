...
class NetworkServer(BaseServer):
    ...
    def start(self):
        """
        Starts the server to begin accepting and processing request_handlers on the given IO.
        :return: None
        """
    ...
    def _accept_connections(self):
        """
        A blocking function which accepts incoming connections and begins processing requests.
        :return: None
        """
    ...
    def stop(self):
        """
        Stops the server from processing requests and tears down the underlying socket.
        :return: None
        """
